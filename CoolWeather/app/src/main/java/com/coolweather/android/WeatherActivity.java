...
public class WeatherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Wind_dirText = (TextView) findViewById(R.id.wind_dir);
        Wind_scText = (TextView) findViewById(R.id.wind_sc);
        pcpnText = (TextView) findViewById(R.id.pcpn);
        visText = (TextView) findViewById(R.id.vis);
    ...
    public void requestWeather(final String weatherId) {
        String weatherUrl = "http://guolin.tech/api/weather?cityid=" + weatherId + "&key=5aba7668d42a444bb33885d7f9269261";
    ...
    private void showWeatherInfo(Weather weather) {
        ...
        flText.setText(fl);
        Wind_dirText.setText(windDir);
        Wind_scText.setText(windSc);
        humText.setText(hum);
